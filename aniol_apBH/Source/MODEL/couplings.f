...
c
      ...
      integer Nin, Nout
      parameter (Nin=2,Nout=4)  ! for trident
...
c      Anuc = 183.84 !tungsten
      Anuc = 180.95 ! tantalum
      aval = 111.0/( elmass*Znuc**(1.0/3.0) )
c      aval = 106.0/( elmass*Znuc**(1.0/3.0) ) ! Beryllium
      dval = 0.164/Anuc**(2.0/3.0)
      apval = 773.0/( elmass*Znuc**(2.0/3.0) ) 
c      apval = 571.4/( elmass*Znuc**(2.0/3.0) ) ! Beryllium
